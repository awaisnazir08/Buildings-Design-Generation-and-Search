...
class Generator(nn.Module):
    def __init__(self, in_channels = 3, features = 64):
        ...
        self.up5 = Block(features*8*2, features*8, down = False, act = 'relu', use_dropout = False)
        self.up6 = Block(features*8*2, features*4, down = False, act = 'relu', use_dropout = False)
        self.up7 = Block(features*4*2, features*2, down = False, act = 'relu', use_dropout = False)
        self.up8 = Block(features*2*2, features, down = False, act = 'relu', use_dropout = False)
